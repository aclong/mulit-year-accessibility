...
# this version copntains a separate input for when the destinations are taken from as it is just editing input date for a bank holiday issue
        ...
        def do_the_stuff(h, m):
            ...
            with open(fl_out, 'a') as fo:
                for o in origs:
                    ...
                    dests = otp.loadCSVPopulation(indir+'/'+dest_file_no_ext+'/'+destdate+'_'+o.getStringData('oa11cd')+'_dests.csv', 'am_lat', 'am_lon')
